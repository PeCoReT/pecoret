"""
ORIGINAL: https://raw.githubusercontent.com/niwinz/django-jinja/master/django_jinja/management/commands/makemessages.py
...
class Command(makemessages.Command):
    ...
    def _get_default_jinja_template_engine(self):
        ...
        return [e for e in engines.templates.values() if e["BACKEND"] == "django.template.backends.django.DjangoTemplates"][0]
